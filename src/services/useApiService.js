...
export function useApiService() {
    ...
    const rAuthUserInfo = useSelector((state) => state.authUserInfo);
    ...
    const getAllJobRecords = async ()=>{
        ...
        // const url = process.env.REACT_APP_OKTA_GET_ALL_JOBRECORDS;
        const url = "http://localhost:8080/api/v1/jobrecord"
