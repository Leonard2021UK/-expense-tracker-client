...
import ExpenseAddressForm from "../../Forms/ExpenseAddressForm/ExpenseAddressForm";

function CreateExpenseAddressModal(props){
                ...
                <Container fluid style={{padding:1+"vw"}}>
                    <Row>
                        <Col>
                            ...
                            <ExpenseAddressForm toggleModal={toggleModal}/>
                        </Col>
                    </Row>
                </Container>
...
export default CreateExpenseAddressModal;