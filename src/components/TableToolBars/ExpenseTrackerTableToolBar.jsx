...
const ExpenseTrackerTableToolBar = (props)=>{
    ...
    return (
        <>
            <FontAwesomeIcon name="add" onClick={toggleExpenseTrackerModal} icon={faPlusSquare} className="fas fa-2x" color={"green"} style={{margin:1+"vh",cursor:"pointer"}} />
            <Tooltip
                delay={0}
                target="add"
                placement="top"
...
export default ExpenseTrackerTableToolBar;